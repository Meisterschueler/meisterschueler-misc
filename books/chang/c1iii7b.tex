...
\textbf{Lesen Sie \autoref{c1iii4b} über das \hyperref[c1iii4b]{Spielen mit flachen Fingern}\index{Spielen mit flachen Fingern}; dieser Abschnitt ist obligatorischer Stoff, bevor Sie eine der Übungen für parallele Sets ernsthaft ausführen.}
...
\textbf{Die meisten der komplexen parallelen Sets, die technisch wichtig sind, können in Bachs Unterrichtsstücken gefunden werden, besonders in den \hyperref[c1iii20]{zweistimmigen Inventionen}\index{zweistimmigen Inventionen}} (s. \autoref{c1iii20}).
...
Stellen Sie sich zur Verdeutlichung der Nützlichkeit dieser Übungen vor, daß Sie einen zusammengesetzten vierfingrigen Triller basierend auf \hyperref[c1iii7b5]{Übung \#5}\index{Übung \#5} üben möchten (z.B. C.E,D.F,C.E,D.F, \dots).
