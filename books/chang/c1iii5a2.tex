...
\subsection{Daumenübersatz üben: Geschwindigkeit, Glissandobewegung}
\label{c1iii5c}
...
Benutzen Sie zunächst die \hyperref[c1iii7b]{Übungen für parallele Sets} (\ref*{c1iii7b}), um ein schnelles 123 zu erreichen, wobei die 1 auf dem \hyperref[Noten]{C4} ist.
...
Die letzte 1 in 1231 ist die Verbindung, die aufgrund der \hyperref[c1ii8]{Kontinuitätsregel} (siehe \ref*{c1ii8}) erforderlich ist.
...
\subsection{Tonleitern: Herkunft, Namensgebung, Fingersätze}
\label{c1iii5d}
