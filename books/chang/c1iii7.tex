...
Die häufigste Ursache ist \hyperref[fpd]{FPD (Schnellspiel-Abbau)}\index{FPD (Schnellspiel-Abbau)}, der am Ende von Abschnitt II.25 besprochen wurde.
...
Merken Sie sich dieses Konzept der schnellen Muskeln, da es dieser grundlegende schnelle Fingerschlag (auf- oder abwärts) ist, den Sie bei jeder hier besprochenen Übung trainieren müssen; sehen Sie dazu den \enquote{\hyperref[c1iii7i]{schnellen Anschlag}\index{schnellen Anschlag}} in Abschnitt (i).
