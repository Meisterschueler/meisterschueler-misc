...
Dieses Wissen über die Komponenten der Technik ist auch bei der \hyperref[c1iii14]{Vorbereitung auf Konzerte}\index{Vorbereitung auf Konzerte} wichtig, weil man in diesem Fall fragen muß: \enquote{Was ist die beste Art, die Hände aufzuwärmen und zu konditionieren?}
...
Die häufigste Ursache ist \hyperref[fpd]{FPD (Schnellspiel-Abbau)}\index{FPD (Schnellspiel-Abbau)}, der am Ende von \autoref{c1ii25} besprochen wurde.
...
%: bisher 7i Ende
Solides \hyperref[c1ii12]{mentales Spielen}\index{mentales Spielen} kann Löcher vermeiden; zumindest können Sie mit ihm erkennen, daß Sie sich in einem Loch befinden, \textit{bevor} sie spielen.
...
Deshalb ist das mentale Spielen so wichtig, wenn Sie \hyperref[c1iii14]{vorspielen}\index{vorspielen}.
...
Merken Sie sich dieses Konzept der schnellen Muskeln, da es dieser grundlegende schnelle Fingerschlag (auf- oder abwärts) ist, den Sie bei jeder hier besprochenen Übung trainieren müssen; sehen Sie dazu den \enquote{\hyperref[c1iii7i]{schnellen Anschlag}\index{schnellen Anschlag}} in \autoref{c1iii7i}.
