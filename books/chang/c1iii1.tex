...
\chapter{Ausgewählte Themen des Klavierübens}\hypertarget{c1iii1}{}

% zuletzt geändert 14.02.2010

\section{Klang, Rhythmus, Legato, Staccato}

\subsection{Was ist ein \enquote{Guter Klang}?}\hypertarget{c1iii1a}{}

\subsubsection{Der Basisanschlag}\hypertarget{c1iii1a1}{}
...
Diese Kontrolle ist nicht so einfach, da wir im Abschnitt über den \hyperlink{c1ii10}{Freien Fall} herausgefunden haben, dass ein schnellerer Abschlag im Allgemeinen zu einem lauteren Ton führt.
...
Vorausgesetzt, das Klavier ist richtig \hyperlink{c2_7_hamm}{intoniert}, können Sie sehr leise pianissimo spielen, indem Sie zunächst die Reibung bzw. die Trägheit überwinden und dann den sanften Abschlag machen.
...
Der erforderliche schnelle Abschlag bedeutet, dass die Fingermuskeln zu einem großen Teil aus schnellen Muskelfasern bestehen müssen (siehe unten \hyperlink{c1iii7a}{Abschnitt 7a}).
...
Beim \hyperlink{c1iii1c}{Staccato} und Legato (siehe Abschnitt c) und schnellen Spielen (7i) müssen wir alle diese Komponenten verändern, und wir werden das gesondert behandeln.
Wenn Sie diese Komponenten nie zuvor geübt haben, beginnen Sie das Üben mit allen fünf Fingern, C bis G, wie beim Spielen einer Tonleiter, und wenden Sie alle Komponenten auf jeden einzelnen Finger an (\hyperlink{c1ii7}{mit getrennten Händen}).
...
Machen Sie nun dasselbe mit getrennten Händen mit einem langsamen Musikstück, das Sie spielen können, wie dem \hyperlink{c1ii25b}{ersten Satz von Beethovens Mondschein-Sonate}.
Wenn Sie es vorher noch nie getan haben, wird das \hyperlink{c1ii25}{beidhändig} zunächst sehr merkwürdig sein, weil Sie so viele Komponenten mit beiden Händen koordinieren müssen.
...
Ohne einen guten Basisanschlag können Sie in Schwierigkeiten geraten, wenn Sie auf verschiedenen Klavieren oder auf nicht gut eingestellten Klavieren spielen, und die Musik kann nach häufigerem Üben oft schlechter sein, da Sie sich \hyperlink{c1ii22}{schlechte Angewohnheiten} aneignen können, zum Beispiel ein ungenaues Timing.
...
\subsubsection{Klang: Einzelne gegenüber mehreren Noten, Pianissimo, Fortissimo}\hypertarget{c1iii1a2}{}
...
Wir können ihn durch den Gebrauch des Halte- und des Dämpferpedals steuern\footnote{Anmerkungen zu den Bezeichnungen der Pedale finden Sie \hyperlink{Pedale}{hier}}.
Wir können auch den harmonischen Gehalt (die Zahl der Obertöne) ändern, indem wir lauter oder leiser spielen.
Das \hyperlink{c1ii24}{Dämpferpedal ändert den Klang, oder das Timbre}, durch die Reduzierung des Anschlagklangs relativ zum Nachklang.
...
\textbf{Der Klang oder das Timbre können vom Klavierstimmer durch das \hyperlink{c2_7_hamm}{Intonieren der Hämmer} oder durch eine andere Stimmung gesteuert werden.}
...
Der Klavierstimmer kann die \hyperlink{c2_5_stre}{Streckung} ändern oder den Grad der Verstimmung in den Unisoni steuern.
...
Wenn alle Saiten einer Note innerhalb des \hyperlink{c2_5_mits}{Mitschwingungsbereichs} verstimmt werden, sind sie in perfekter Stimmung (schwingen mit der gleichen Frequenz), reagieren aber unterschiedlich miteinander.
...
Die Existenz der Biegung des Hammerstiels ist nun wohlbekannt (\hyperlink{Lectures}{Five Lectures on the Acoustics of the Piano}).
...
Spielen Sie zunächst mit Armgewicht und \enquote{pressen Sie tief} in das Klavier, und stellen Sie sicher, dass der Tastenfall den ganzen Weg nach unten beschleunigt wird (korrekter \hyperlink{c1iii1a1}{Basisanschlag}).
...
\textbf{Pianissimo}:
Wir haben gesehen, dass man für \textit{ppp} einen genauen \hyperlink{c1iii1a1}{Basisanschlag} und eine schnelle \hyperlink{c1ii14}{Entspannung} benötigt.
...
\textbf{Der wichtigste Faktor für \textit{ppp} ist das richtige Einstellen des Klaviers (besonders ein minimaler Abgang, das \hyperlink{c2_7_hamm}{Intonieren der Hämmer} und das richtige Hammergewicht).
Zu versuchen, die Technik des \textit{ppp} ohne die richtige Wartung des Klaviers zu erreichen und zu erhalten ist sinnlos.}
Im Notfall (während einer \hyperlink{c1iii14}{Aufführung} mit einem ungenügenden Instrument), können Sie es bei einem Klavier mit dem \hyperlink{c1ii24}{Dämpferpedal} und bei einem Flügel mit teilweise getretenem Dämpferpedal versuchen.
...
Die \hyperlink{c1ii14}{Entspannung} ist wieder wichtig, sodass Sie keine Energie verschwenden, für eine maximale Geschwindigkeit des Abschlags sorgen und die richtige Kraft nur dorthin richten, wo Sie benötigt wird.
...
\subsection{Was ist Rhythmus? (Beethovens Sturm-Sonate und Appassionata)}\hypertarget{c1iii1b}{}

\textbf{Rhythmus ist der (sich wiederholende) zeitliche Rahmen der Musik}.
Wenn man etwas über Rhythmus liest (siehe \hyperlink{Whiteside}{Whiteside}), erscheint er oft wie ein mysteriöser Aspekt der Musik, den man nur mit \enquote{angeborenem Talent} zum Ausdruck bringen kann.
...
\textbf{Prüfen Sie den Rhythmus sorgfältig, wenn Sie mit \hyperlink{c1ii7}{getrennten Händen} beginnen.
Prüfen Sie ihn noch einmal, wenn Sie mit dem \hyperlink{c1ii25}{beidhändigen Üben} anfangen.
...
Das ist einer der Gründe, warum das \hyperlink{c1iii8}{Konturieren} funktioniert: Es kann das korrekte Lesen des Rhythmus vereinfachen.
...
\subsection{Legato, Staccato}\hypertarget{c1iii1c}{}
...
Der \hyperlink{c1iii1a1}{Basisanschlag} ist eine Voraussetzung für das Legato.
...
Deshalb ist die Halte-Komponente des \hyperlink{c1iii1a1}{Basisanschlags} nicht vorhanden.
...
\item Fingerstaccato,\item Handgelenksstaccato,\item Armstaccato, was sowohl die Auf- und Abbewegung als auch die Drehung des Arms einschließt.
 \end{enumerate}
(i) wird hauptsächlich mit den Fingern gespielt, wobei die Hand und der Arm stillgehalten werden, (ii) wird hauptsächlich mit Bewegung des Handgelenks gespielt, und (iii) wird üblicherweise mit \hyperlink{c1iii4SchubZug}{Schub} (siehe III.4a) gespielt, wobei die Spielbewegung aus dem Oberarm kommt.
