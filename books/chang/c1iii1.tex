...
\ref{enum2a} wird hauptsächlich mit den Fingern gespielt, wobei die Hand und der Arm stillgehalten werden, \ref{enum2b} wird hauptsächlich mit Bewegung des Handgelenks gespielt, und \ref{enum2c} wird üblicherweise mit \hyperref[c1iii4SchubZug]{Schub}\index{Schub} (siehe III.4a) gespielt, wobei die Spielbewegung aus dem Oberarm kommt.
