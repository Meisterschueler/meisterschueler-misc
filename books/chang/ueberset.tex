...
In den Abschnitten über \hyperref[c1iii13MIDI]{MIDI, Digitalpianos usw.}\index{MIDI, Digitalpianos usw.} hat es mich ja förmlich in den Fingern gejuckt aber ich habe die Begriffe \textbf{Motherboard, Soundkarte usw.} kommentarlos dringelassen, da jemand, der sich mit PCs auskennt, weiß was gemeint ist.
...
\label{ueb-KV525}
Der Text des Wortwechsels der männlichen und weiblichen Stimme am Anfang von Mozarts \hyperref[KV525]{\enquote{Eine Kleine Nachtmusik} (KV525)}\index{\enquote{Eine Kleine Nachtmusik} (KV525)} stammt nicht aus der Sekundärliteratur.
...
In der Übersetzung der Datei über \hyperref[c2_1]{das Stimmen}\index{das Stimmen} war aber zunächst nicht immer sofort zu erkennen, welche der beiden Bedeutungen jeweils gemeint war.
...
\begin{tabular}{l|l|l|l}
 \textbf{Intervall} & \textbf{1. Ton} & \textbf{2. Ton} & \textbf{Schwebung} \\
 \hline
...
Diese Werte gelten nur für idealisierte Saiten. Die Obertöne und somit auch die Schwebungsfrequenzen realer Saiten weichen wegen der \hyperref[c2_5_stre]{Inharmonizität}\index{Inharmonizität} davon ab.
...
FI = Fantaisie Impromptu, Op. 66, von Frederic Chopin /
 \hyperref[FI]{(1)}\index{(1)},
 \hyperref[c1iii2]{(2)}\index{(2)},
 \hyperref[c1iii5wagen]{(3)}\index{(3)}<br>
FPD = Fast Play Degradation = \hyperref[fpd]{Abbau von Fähigkeiten durch zu schnelles Spielen}\index{Abbau von Fähigkeiten durch zu schnelles Spielen}<br>
NG = Nucleation Growth = \hyperref[ng]{Kernbildung-Wachstums-Mechanismus}\index{Kernbildung-Wachstums-Mechanismus}<br>
PPI = Post Practice Improvement = \hyperref[c1ii15]{automatische Verbesserung der Fähigkeiten nach dem Üben}\index{automatische Verbesserung der Fähigkeiten nach dem Üben}<br>
ET = Equal Temperament = gleichschwebende, gleichstufige, bzw. gleichmäßige Temperatur
 (\hyperref[et1]{\autoref{et1}}),
 (\hyperref[c2_6_et]{2}\index{2})<br>
WT = Well Temperament(s) = \hyperref[c2_2_wtk2]{Wohltemperierte Stimmung(en)}\index{Wohltemperierte Stimmung(en)}<br>
HT = Historical Temperament(s) = \hyperref[c2_2_hist]{Historische Temperatur(en)}\index{Historische Temperatur(en)}<br>
K-II = Kirnberger II
 (\hyperref[c2_2_wtk2]{\autoref{c2_2_wtk2}}),
 (\hyperref[c2_6_kirn]{2}\index{2})<br>
<br>
