...
In seiner \hyperlink{c1iii2fi}{Fantaisie Impromptu (Op. 66)} können die sechs Noten jedes LH-Arpeggios (z.B. \textit{\hyperlink{Noten}{C\#3}, G\#3, C\#4, E4, C\#4, G\#3}) zu zwei Noten vereinfacht werden (\textit{C\#3.E4} gespielt mit 51).
...
Wenn Sie die Geschwindigkeit zunächst auf diese Art steigern, wird es später einfacher sein, sich das 3-4-Timing anzueignen, besonders wenn Sie nur einen halben Takt \hyperlink{c1iii2}{zirkulieren}.

Die zweite Anwendung ist Beethovens Sonate \#1 (Op. 2, No. 1).
Ich habe im Quellenverzeichnis angemerkt, daß \hyperlink{Gieseking}{Gieseking} nachlässig war, als er den vierten Satz trotz des schwierigen und sehr schnellen LH-Arpeggios mit \enquote{bringt keine weiteren neuen Probleme}\footnote{S. 38} bewertete.
...
Die ersten vier Triolen der LH kann man lernen, indem man die \hyperlink{c1iii7b}{Übungen für parallele Sets} auf jede Triole anwendet und danach \hyperlink{c1iii2}{zirkuliert}.
