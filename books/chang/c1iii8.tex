...
In seiner \hyperref[c1iii2fi]{Fantaisie-Impromptu (Op. 66)}\index{Chopin!Fantaisie-Impromptu (FI, Op. 66)} können die sechs Noten jedes LH-Arpeggios (z.B. \textit{\hyperref[Noten]{C\#3}\index{C\#3}, G\#3, C\#4, E4, C\#4, G\#3}) zu zwei Noten vereinfacht werden (\textit{C\#3.E4} gespielt mit 51).
