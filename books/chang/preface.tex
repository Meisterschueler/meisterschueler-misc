...
\item \label{epreface1a} private Lehrer, die nicht unterrichten können,
\item \label{epreface1b} private Lehrer, die sehr gut sind, und
\item \label{epreface1c} Lehrer an Universitäten und Konservatorien.
\end{enumerate}
...
Die Gruppe \ref{epreface1a} besteht hauptsächlich aus \enquote{Einzelkämpfern}, die sich nicht so sehr mit anderen Lehrern austauschen und hauptsächlich die intuitiven Methoden benutzen; das erklärt, warum sie nicht unterrichten können.
...
Die Gruppen \ref{epreface1b} und \ref{epreface1c} sind mit den korrekten Übungsmethoden ziemlich vertraut, obwohl wenige sie alle kennen, weil es kein standardisiertes Lehrbuch gab; auf der anderen Seite wissen die meisten von Ihnen eine Menge nützlicher Details, die nicht in diesem Buch enthalten sind.
Es gibt herzlich wenige Lehrer der Gruppe \ref{epreface1b} und die Lehrer der Gruppe \ref{epreface1c} akzeptieren im Allgemeinen nur fortgeschrittene Schüler.
Das Problem mit dieser Situation ist, dass die meisten Schüler mit Lehrern der Gruppe \ref{epreface1a} anfangen und nie über das Anfänger- oder Mittelstufenniveau hinauskommen und sich deshalb niemals für die Lehrer der Gruppe \ref{epreface1c} qualifizieren.
