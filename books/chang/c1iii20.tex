...
\section{Bach: der größte Komponist und Lehrer (15 Inventionen)}\hypertarget{c1iii20}{} 
...
Jede Invention benutzt eine andere der Tonleitern, die in den zu Bachs Zeiten favorisierten \hyperlink{c2_2_wtk2}{Wohltemperierten Stimmungen} wichtig waren.
...
Die bemerkenswerteste Eigenschaft aller Inventionen ist, daß jede sich auf eine kleine Zahl \hyperlink{c1iii7b}{paralleler Sets} konzentriert, gewöhnlich weniger als drei.
...
Um sich ganz auf einfache parallele Sets zu konzentrieren, vermied Bach völlig den Gebrauch von Terzen und komplexeren Intervallen (in einer Hand), die \hyperlink{c1iii7h}{Hanon} in seinen Übungen mit höheren laufenden Nummern benutzt hat.
...
Lineare Sets wie in \hyperlink{c1iii20ps01}{\#1} aber mit einer größeren Vielfalt in den Verbindungen.
...
Obwohl sie einfach sind, sind sie extrem wichtige technische Grundelemente, und sie zwischen den beiden Händen zu wechseln, ist eine großartige Möglichkeit, zu lernen sie zu kontrollieren (indem man \hyperlink{c1ii20}{eine Hand benutzt, um die andere zu unterrichten}, s. Abschnitt II.20).
...
543231.
Das ist wie eine Kombination von \hyperlink{c1iii20ps03}{\#3} und \hyperlink{c1iii20ps04}{\#4} und ist deshalb komplexer als beide.
...
Der Lehrstoff ist hier ähnlich dem in \hyperlink{c1iii20ps02}{\#2} (lineare Sets) aber schwieriger.
...
Ähnlich wie \hyperlink{c1iii20ps02}{\#2} und \hyperlink{c1iii20ps09}{\#9}.
...
Arpeggioartige Sets, wird schneller gespielt als \hyperlink{c1iii20ps10}{\#10}.


\item \hypertarget{c1iii20ps14}{}

12321, 43234.
Eine schwierigere Version von \hyperlink{c1iii20ps03}{\#3} (fünf Noten statt drei und schneller).
