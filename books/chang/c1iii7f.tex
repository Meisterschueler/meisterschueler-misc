...
Die \hyperref[c1iii4b]{flachen Fingerhaltungen}\index{flachen Fingerhaltungen} sind dafür wichtig, weil Sie den empfindlichsten Teil der Finger für das Erfühlen der Tasten benutzen können und diese Haltungen die Genauigkeit beim Treffen der Tasten, insbesondere der schwarzen, erhöhen.
...
Es ist möglich, sich dabei selbst zu verletzen, und bedeutende Verbesserungen lassen sich nur mit der \hyperref[c1ii15]{Automatischen Verbesserung nach dem Üben (PPI)}\index{Automatischen Verbesserung nach dem Üben (PPI)} erzielen.
...
Die meisten Dehnungsübungen für die großen Muskeln des Körpers sind hilfreich (s. \hyperref[Bruser]{Bruser}\index{Bruser}).
...
Sie könnten diese Dehnungsübungen unmittelbar vor dem \enquote{\hyperref[c1iii6g]{kalt Spielen}\index{kalt Spielen}} ausführen.
