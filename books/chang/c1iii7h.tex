...
Das konditioniert die Hände so, daß Sie unfähig werden, sich einfach hinzusetzen und \enquote{\hyperref[c1iii6g]{kalt}\index{kalt}} zu spielen; etwas, das jeder vollendete Pianist innerhalb vernünftiger Grenzen können sollte.}
...
Die \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} bieten Ihnen sowohl die Diagnosewerkzeuge als auch die Lösungen für praktisch jede Situation einschließlich der Verzierungen usw., die Hanon noch nicht einmal berücksichtigt.
...
Es ist wahr, daß die Streckmuskeln oft vernachlässigt werden, aber es gibt \hyperref[c1iii7finger]{Übungen}\index{Übungen}, um dieses Problem direkt zu behandeln.
...
Und seine Empfehlung ignoriert völlig die \hyperref[c1ii14]{Entspannung}\index{Entspannung}.
...
\item Er kennt offenbar nur den Daumenuntersatz, während der \hyperref[c1iii5a]{Daumenübersatz}\index{Daumenübersatz} wichtiger ist.

\item Bei den meisten Übungen empfiehlt er ein festes Handgelenk, was nur teilweise korrekt ist.
Seine Empfehlung offenbart einen Mangel an Verständnis, was \enquote{\hyperref[ruhig]{ruhige Hände}\index{ruhige Hände}} sind.
...
\item \label{c1iii7h8}\textbf{Die Hanon-Übungen erlauben es nicht, mit den Geschwindigkeiten zu üben, die mit den oben beschriebenen \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} möglich sind.}
Ohne solche Geschwindigkeiten zu benutzen, können bestimmte hohe Geschwindigkeiten nicht geübt werden, können Sie nicht die \enquote{Über-Technik} trainieren (d.h. mehr Technik als für das Spielen dieser Passage notwendig ist -- eine notwendige Sicherheitsreserve für \hyperref[c1iii14]{Auftritte}\index{Auftritte}), und die Hanon-Übungen bieten keine Möglichkeit, ein bestimmtes technisches Problem zu lösen.
