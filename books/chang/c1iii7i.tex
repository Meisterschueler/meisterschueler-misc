...
Das erklärt auch, warum \hyperref[c1iii4b]{flache Fingerhaltungen}\index{flache Fingerhaltungen} schneller sind als die gebogenen.
...
Die Bewegung an den Knöcheln fördert auch sehr die \hyperref[c1ii14]{Entspannung}\index{Entspannung}.
Wie im folgenden besprochen, müssen Sie beim schnellen Spielen auch das schnelle Entspannen üben.

\textbf{Wir müssen nun jede der drei Komponenten des \hyperref[c1iii1a1]{Basisanschlags}\index{Basisanschlags} (siehe 1a) beschleunigen.}
...
Deshalb sind Übungen wie \hyperref[c1iii7h]{Hanon}\index{Hanon} so schädlich -- sie halten Sie vom Lernen dieser speziellen Tricks ab, indem sie Sie zu dem falschen Glauben verleiten, daß Hanon alle diese allgemeinen und speziellen Probleme lösen wird.
...
Die \hyperref[c1ii11]{parallelen Sets}\index{parallelen Sets} lehren Ihnen, alle Finger gleichzeitig zu bewegen, so daß aufeinander folgende Noten viel schneller als mit der Geschwindigkeit jedes einzelnen Fingers gespielt werden können.
...
Die \hyperref[c1iii4b]{flachen Fingerhaltungen}\index{flachen Fingerhaltungen} können schneller als die gebogenen sein, weil sie die Krümmungslähmung vermeiden, und die Fingerspitzen ausgestreckter Finger können sich schneller bewegen als die Spitzen gekrümmter Finger.
...
Ein \hyperref[c1iii1a]{guter Klang}\index{guter Klang} wird erzeugt, indem man \enquote{tief in das Klavier hineingeht}.
...
Die \hyperref[c1iii3]{Triller}\index{Triller} und Verzierungen werden auch schneller und klarer.
...
\hyperref[c1iii1b]{Rhythmus}\index{Rhythmus} ist extrem wichtig.
...
\textbf{Viele dieser unerwünschten Bewegungen werden sichtbar, wenn man \hyperref[c1iii13]{sich selbst auf Video aufnimmt}\index{sich selbst auf Video aufnimmt}.}
Selbstverständlich muß man zunächst einmal den richtigen Rhythmus im Kopf haben; lassen Sie sich den Rhythmus nicht vom Klavier diktieren, da der Rhythmus genauso ein Teil der Musik ist wie die Melodie; man muß ihn bewußt durch das \hyperref[c1ii12]{mentale Spielen}\index{mentale Spielen} kontrollieren.
...
In Abhängigkeit von der Situation werden Sie die an anderer Stelle besprochenen Methoden benötigen, wie den \hyperref[c1iii5b]{Daumenübersatz}\index{Daumenübersatz}, die \hyperref[c1iii5wagen]{Wagenradbewegung}\index{Wagenradbewegung}, \hyperref[c1iii4b]{mit flachen Fingern spielen}\index{mit flachen Fingern spielen}, \hyperref[c1iii8]{Konturieren}\index{Konturieren} usw.
...
Außerdem müssen Sie wissen, wie man den größten Nutzen aus der \hyperref[c1ii15]{automatischen Verbesserung nach dem Üben (PPI)}\index{automatischen Verbesserung nach dem Üben (PPI)} zieht.
...
Eine der besten Methoden zur Entwicklung der Musikalität ist, das eigene Spielen \hyperref[c1iii13]{aufzunehmen oder zu filmen}\index{aufzunehmen oder zu filmen}, sich die Aufnahme kritisch anzuhören oder anzusehen und dabei jene hohe Stufe des musikalischen Urteilsvermögens zu benutzen, über die wir alle verfügen.
...
\textbf{Fehler beim Notenlesen, besonders beim \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus}, können es unmöglich machen, ein Stück auf die endgültige Geschwindigkeit zu bringen.}

Die meisten nehmen einfach an, daß sie, wenn sie üben, auch üben \hyperref[c1iii14]{vorzuspielen}\index{vorzuspielen}.
...
Sie können kurzzeitig parallele Sets, \hyperref[c1iii2]{Zirkulieren}\index{Zirkulieren} usw. benutzen, um die Geschwindigkeit unter einer geringeren Beachtung der Musikalität schnell zu steigern, aber Sie sollten das die Ausnahme sein lassen, nicht die Regel.
...
Als nächstes müssen Sie alle analytischen Methoden für das Steigern der Geschwindigkeit verinnerlichen, wie die Entspannung, die verschiedenen Hand- und Fingerhaltungen, den \hyperref[c1iii5b]{Daumenübersatz}\index{Daumenübersatz}, den korrekten Abwärtsdruck usw.
