...
Sehr junge Kinder, die genügend oft perfekt gestimmte Klaviere hören, erwerben automatisch ein \hyperlink{c1iii12}{absolutes Gehör}, obwohl die meisten Eltern das nicht bemerken, weil es, wenn es nicht erkannt und gepflegt wird, in der Jugendzeit wieder verlorengeht.
...
\textbf{Die Wichtigkeit eines gut gestimmten Klaviers für die musikalische und technische Entwicklung kann nicht überbetont werden, denn ohne die musikalische Entwicklung wird man nie lernen, \hyperlink{c1iii14}{vorzuspielen und aufzutreten}.}
...
Die Möglichkeit, die Lautstärke herunterzudrehen, ist auch zum Vermindern von \hyperlink{c1iii10gehoer}{Gehörschäden} beim Üben lauter Passagen nützlich: ein wichtiger Faktor für jeden, der älter als 60 Jahre ist; ein Alter, in dem viele unter einsetzendem Hörverlust oder Tinnitus leiden.
...
Man muß jedoch wissen, was \enquote{Spielgewicht} bedeutet, bevor man es vorteilhaft einsetzen kann; \hyperlink{touchweight}{Details} finden Sie weiter unten.
...
%: 6
\item Klaviermusik \hyperlink{c1iii13}{aufzunehmen} ist mit einer konventionellen Ausrüstung eine der schwierigsten Aufgaben.
...
Aufzunehmen ist nicht nur eine der besten Möglichkeiten, Ihre Stücke wirklich zu vollenden und auf Hochglanz zu polieren, sondern auch um zu lernen, \hyperlink{c1iii14}{wie man für ein Publikum spielt}.
...
Zu viele Schüler nehmen ihre Stücke niemals auf, was der Hauptgrund für übermäßige \hyperlink{c1iii15}{Nervosität} und Schwierigkeiten während des Vorspielens ist.
...
%: 9
\item Ein elektronisches Klavier zu kaufen ist ziemlich einfach, besonders wenn man es mit dem \hyperlink{c1iii17e}{Kauf eines akustischen Klaviers} vergleicht (s.u.).
...
%: 11
\item Wir sollten von der \hyperlink{c2_6_et}{gleichschwebenden Stimmung} zu den \hyperlink{c2_2_wtk2}{wohltemperierten Stimmungen} (siehe im \hyperlink{c2_1}{Kapitel über das Klavierstimmen}) übergehen.
...
Flügel erfordern ein häufigeres \hyperlink{c2_7_hamm}{Intonieren der Hämmer} als Klaviere; sonst werden sie zu \enquote{brillant} oder \enquote{schrill}, und an diesem Punkt spielen die meisten Besitzer schließlich nur noch bei geschlossenem Deckel.
