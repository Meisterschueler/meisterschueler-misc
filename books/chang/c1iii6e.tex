...
Beginnen Sie mit dem Auswendiglernen, indem Sie einfach die Anweisungen in den \hyperlink{c1i1}{Abschnitten I} und \hyperlink{c1ii1}{II} befolgen und dabei jeden Abschnitt auswendig lernen, bevor Sie anfangen ihn zu üben.
...
Das ist der Zeitpunkt, an Ihren \hyperlink{c1iii7f}{Sprüngen} und \hyperlink{c1iii7e}{Akkorden} zu arbeiten (Abschnitte III.7e, f).
...
\item Langsames Spielen ist einer der besten Wege, um Ihre Hand von schlechten Angewohnheiten zu befreien, besonders von jenen, die Sie unbewußt während des schnellen Übens angenommen haben (\hyperlink{fpd}{FPD}).
