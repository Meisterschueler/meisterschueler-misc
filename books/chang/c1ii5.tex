...
\subsection{Die Hände getrennt (einhändig, \hyperref[HsHt]{HS}\index{HS}) üben -- Erlernen der Spieltechnik}
\label{c1ii7}
...
Wer mit dem getrennten Üben der Hände nicht vertraut ist, hat im Allgemeinen eine \hyperref[c1ii20]{schwächere linke Hand}\index{schwächere linke Hand}.
...
Das ist das Auswendiglernen; aus mehreren wichtigen Gründen (siehe \enquote{\hyperref[c1iii6]{Auswendiglernen}\index{Auswendiglernen}} in Abschnitt III.6) sollten Sie alles einhändig auswendig lernen.
Obwohl Sie vielleicht nicht einhändig üben müssen, sollten Sie deshalb einhändig auswendig lernen, außer wenn Sie ein fortgeschrittener Klavierspieler mit einem guten \hyperref[c1ii12mental]{mentalen Spielen}\index{mentalen Spielen} sind.
...
Die einhändige Methode ist allem überlegen, was \hyperref[c1iii7h]{Hanon}\index{Hanon} oder andere Übungen zur Verfügung stellen können.
...
Deshalb können erfahrene Pianisten \hyperref[c1iii14]{vorspielen}\index{vorspielen}, aber die meisten Amateure können nur für sich selbst spielen.
...
Da die Verbindung dieselbe wie die erste Note ist, können Sie dieses Quadrupel undendlich \hyperref[c1iii2]{zirkulieren}\index{zirkulieren} ohne aufzuhören.
