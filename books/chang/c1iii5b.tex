...
\hypertarget{c1iii5e}{}
\subsection{Arpeggios (Chopin, Wagenradbewegung, \enquote{gespreizte} Finger)}
\label{Arpeggios}
...
\subsubsection{Die Wagenradbewegung (Chopins FI)}
\label{c1iii5wagen}
...
In \ref*{c1iii2} haben wir die \hyperref[c1iii2]{Anwendung des Zirkulierens} beim Üben der linken Hand besprochen.
...
\hypertarget{c1iii5f}{}
\subsection{Schub und Zug, Beethovens Mondschein-Sonate, 3. Satz}
...
Unglücklicherweise bekommt man, wenn man durch Null dividiert, $1/0$, ein unterschiedliches Ergebnis, je nachdem ob $N$ positiv oder negativ ist: \enquote{$1/0 = +\infty$} wenn $N$ positiv ist und \enquote{$1/0 = -\infty$} wenn $N$ negativ ist!
Wenn Sie angenommen haben, dass die beiden Nullen dasselbe sind, könnte Ihr Fehler nach der Division so groß wie \enquote{$2 * \infty$} sein, je nachdem welche Null Sie benutzt haben!
...
Die Alberti-Begleitung kann, wie es ab \hyperref[c1ii8]{\ref*{c1ii8}} erklärt wird, mit \hyperref[c1iii7b]{parallelen Sets} geübt werden.
...
\hypertarget{c1iii5g}{}
\subsection{Der Daumen: Der vielseitigste Finger}
\label{Daumen}
...
\subsection{Schnelle chromatische Tonleitern}
\label{c1iii5h}
