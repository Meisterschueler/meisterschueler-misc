...
Eine Konsequenz aus dieser Abhängigkeit von der Steifheit ist eine Steigerung der Frequenz mit der Zahl der \hyperref[moden]{Schwingungsmoden}\index{Schwingungsmoden}; d.h. der Draht erscheint bei harmonischen Obertönen mit kürzeren Wellenlängen steifer.
...
Das gilt besonders, wenn Sie \enquote{\hyperref[c2_6]{die Bezugsnoten einstellen}\index{die Bezugsnoten einstellen}}, was unten erklärt wird.
...
Die \hyperref[c2_6_kirn]{Kirnberger-Stimmung}\index{Kirnberger-Stimmung} (s.u.) ist einfacher akkurat zu stimmen.
