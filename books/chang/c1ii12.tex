...
Benutzen Sie dann die Notenblätter, um für jede Note die zugehörige Taste zu finden und sich zu merken; das nennt man \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis}\index{Tastatur-Gedächtnis} -- Sie merken sich, wie Sie dieses Stück auf dem Klavier spielen, mit dem Fingersatz, den Handbewegungen usw.
Einige Klavierspieler benutzen das \hyperref[c1iii6foto]{fotografische Gedächtnis}\index{fotografische Gedächtnis} bei dem Sie sich das Notenblatt als komplettes Bild merken.
...
Prägen Sie sich deshalb jeden Abschnitt ein, den Sie für die Technik üben, während Sie diesen viele Male \hyperref[c1ii7]{mit getrennten Händen}\index{mit getrennten Händen} in kleinen Segmenten wiederholen.
\textbf{Die Prozeduren für das Einprägen sind im Grunde mit denen für das Aneignen der Technik identisch.}
Zum Beispiel sollte das Einprägen zunächst mit getrennten Händen erfolgen, für \hyperref[c1ii5]{die schwierigen Abschnitte zuerst}\index{die schwierigen Abschnitte zuerst} usw.
...
Das einzige Vorzeichen in a-Moll ist G\# (siehe \hyperref[tablemoll]{Tabelle der Moll-Tonleitern}\index{Tabelle der Moll-Tonleitern}), das wir in Takt 4 finden; daraus schließen wir, dass es in a-Moll steht.
...
\textbf{Die einzige Möglichkeit, gut auswendig zu lernen, ist, das \hyperref[c1iii6tastatur]{mentale Spielen}\index{mentale Spielen} lernen.}
...
Sie können das \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis}\index{Tastatur-Gedächtnis} oder das \hyperref[c1iii6foto]{fotografische Gedächtnis}\index{fotografische Gedächtnis} für das mentale Spielen benutzen, aber ich empfehle für Anfänger das Tastatur-Gedächtnis, weil es effizienter ist;
...
Trotzdem wird dieser \enquote{Gedächtnistrick}, die Musik als Algorithmus für das Auswendiglernen zu benutzen, Musikschülern selten formal gelehrt; statt dessen wird ihnen oft geraten, stets zu wiederholen, \enquote{bis die Musik in den Händen ist}, was eine der schlechtesten Gedächtnis-Methoden ist, denn wie wir in \hyperref[c1iii6d]{\autoref{c1iii6d}} sehen werden, führt Wiederholung zum \enquote{\hyperref[c1iii6d]{Hand-Gedächtnis}\index{Hand-Gedächtnis}}, was eine falsche Art von Gedächtnis ist, die zu vielen Problemen, wie Gedächtnisblockaden, führen kann.
...
Sie lösen nicht nur die praktischen Probleme der Technik und des \hyperref[c1iii14]{Auftretens}\index{Auftretens}, sondern bringen Sie auch als Musiker voran und steigern die Intelligenz.
...
\textbf{Kommen Sie so schnell wie möglich auf Geschwindigkeit.} Erinnern Sie sich daran, dass wir immer noch \hyperref[c1ii7]{mit getrennten Händen}\index{mit getrennten Händen} üben.
...
Wie beim \hyperref[c1ii11]{parallelen Spielen}\index{parallelen Spielen} gezeigt wurde, brauchen Sie neue Arten zu spielen, die automatisch die Geschwindigkeit erhöhen und den Stress reduzieren.
...
Diese Themen sind die Hauptbeiträge dieses Buchs und werden später im Einzelnen behandelt, da sie zu umfangreich sind, um hier schon behandelt zu werden; dazu gehören so spezifische Fertigkeiten, wie der \hyperref[c1iii5b]{Daumenübersatz}\index{Daumenübersatz}, die \hyperref[c1iii5c]{Glissandobewegung}\index{Glissandobewegung}, die \hyperref[c1ii14]{Entspannung}\index{Entspannung}, die \hyperref[c1iii4b]{flachen Fingerhaltungen}\index{flachen Fingerhaltungen}, die Bewegungen der Arme und Handgelenke sowie die Benutzung der \hyperref[c1ii15]{automatischen Verbesserung nach dem Üben}\index{automatischen Verbesserung nach dem Üben}.
...
Werden Sie dann schneller (indem Sie, wenn notwendig, \hyperref[c1ii11]{parallele Sets}\index{parallele Sets} usw. benutzen), und achten Sie darauf, wie das Spielen geändert werden muss (machen Sie sich nichts daraus, wenn Sie an diesem Punkt nicht exakt spielen, da Sie es nicht viele Male wiederholen).
...
Die \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} von Abschnitt III.7 können Ihnen helfen, das Entspannen zu üben.
...
\item Schalten Sie die arbeitenden Muskeln ab, sobald diese ihre Arbeit verrichtet haben.
 \end{enumerate}
Lassen Sie uns dies mit dem einfingrigen \hyperref[c1ii10]{Freien Fall}\index{Freien Fall} demonstrieren.
