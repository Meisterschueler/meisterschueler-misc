...
Die \hyperref[c1iii15]{Nervosität}\index{Nervosität} ist im allgemeinen unmittelbar bevor man anfängt zu spielen am größten.
...
Einige verzögern das Starten, indem sie die Bank justieren oder etwas an der Kleidung richten, um genügend Zeit zu haben, das Anfangstempo usw. noch einmal mit Hilfe des \hyperref[c1ii12mental]{mentalen Spielens}\index{mentalen Spielens} zu prüfen.
...
Obwohl das \hyperref[c1iii6d]{Hand-Gedächtnis}\index{Hand-Gedächtnis} nichts ist, von dem man abhängen möchte, ist das ein Zeitpunkt, an dem Sie einen Vorteil daraus ziehen können.
...
Wenn Sie Übung darin haben, werden Sie es leichter finden als es klingt; am besten üben Sie es beim \hyperref[c1iii11]{Spielen vom Blatt}\index{Spielen vom Blatt}.
...
Ein weiterer wichtiger Faktor ist die \hyperref[c2_1]{Stimmung des Klaviers}\index{Stimmung des Klaviers}.
...
Diejenigen, die Fehler machen, haben wahrscheinlich noch nicht gelernt, ausreichend musikalisch zu spielen, und können fast immer nicht \hyperref[c1ii12mental]{in Gedanken spielen}\index{in Gedanken spielen}.
