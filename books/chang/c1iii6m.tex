...
Komponisten wie Liszt sind mit diesen Regeln vertraut und können schneller auswendig lernen (siehe dazu \hyperref[c1iv4]{Mozarts Formel}\index{Mozarts Formel} in Kapitel IV.4).
...
Die assoziative Natur des Gedächtnisses erklärt, warum das \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis}\index{Tastatur-Gedächtnis} funktioniert: Sie assoziieren die Musik mit den einzelnen Bewegungen und den Tasten, die zum Erzeugen der Musik gespielt werden müssen.
...
Sie sollten so viele Assoziationen wie möglich herstellen: Bachs Musik kann bestimmte Eigenschaften haben, wie spezielle Verzierungen, kollidierende Hände und \hyperref[c1ii11]{parallele Sets}\index{parallele Sets}.
...
Sich ein \hyperref[c1iii12]{absolutes Gehör oder zumindest ein relatives Gehör}\index{absolutes Gehör oder zumindest ein relatives Gehör} anzutrainieren, ist für das Gedächtnis ebenfalls hilfreich, weil das weitere Assoziationen zu den einzelnen Noten ermöglicht.
...
Wir haben gesehen, daß das endgültige Ziel aller besprochenen Gedächtnisprozeduren das gute und solide \hyperref[c1ii12mental]{mentale Spielen}\index{mentale Spielen} war.
...
Nachdem Sie angefangen haben, das Auswendiglernen und dessen \hyperref[c1iii6k]{Pflege}\index{Pflege} zu üben, können Sie nach und nach die oben besprochenen Konzepte hinzufügen (Assoziationen, Verstehen, Informationen ordnen usw.).
...
HS-Spielen ist auch das Hauptelement der \hyperref[c1iii6k]{Gedächtnispflege}\index{Gedächtnispflege}.
Für das Auswendiglernen können Sie das \hyperref[c1iii6hand]{Hand-Gedächtnis}\index{Hand-Gedächtnis}, \hyperref[c1iii6foto]{fotografische Gedächtnis}\index{fotografische Gedächtnis}, \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis und mentale Spielen}\index{Tastatur-Gedächtnis und mentale Spielen}, \hyperref[c1iii6musik]{Musik-Gedächtnis}\index{Musik-Gedächtnis} und die \hyperref[c1iii6theorie]{Musiktheorie}\index{Musiktheorie} benutzen.
...
Erinnern Sie sich daran, daß die Musik einer der effizientesten Algorithmen für das Gedächtnis ist; ein \hyperref[c1iii12]{absolutes Gehör}\index{absolutes Gehör} ist ebenfalls hilfreich.
...
Auswendiglernen ist notwendig, um ein Stück schnell und gut zu lernen, \hyperref[c1iii14d]{musikalisch zu spielen}\index{musikalisch zu spielen}, sich schwierige Technik anzueignen usw.
