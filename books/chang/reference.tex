...
\hyperlink{Whiteside}{Whitesides Buch} wurde deshalb weithin anerkannt, weil es der erste wirkliche Versuch war, mit einer wissenschaftlichen Vorgehensweise die besten Übungsmethoden zu entdecken.
...
\item \hyperlink{Chang}{Changs Buch} (besonders diese zweite Ausgabe) ist das einzige, das die Übungsmethoden dafür zur Verfügung stellt, bestimmte anfängliche technische Probleme (Überwindung von \hyperlink{c1iv2b}{Geschwindigkeitsbarrieren}, \hyperlink{c1ii14}{Entspannung}, \hyperlink{c1ii21}{Ausdauer}, \hyperlink{c1iii6}{Auswendiglernen}, \hyperlink{c1iii6h}{langsames} gegenüber \hyperlink{c1ii13}{schnellem} Üben usw.) zu lösen, die im Anfängerstadium gelernt werden sollten aber nicht immer gelehrt werden.
...
Die auf dieser Website \hyperlink{Inhalt}{zum freien Download vorliegende zweite Ausgabe} ist eine aktualisierte und erweiterte Fassung der ersten Ausgabe.
\textbf{Muß man gelesen haben.}


\hypertarget{Eigeldinger}{}
...
Stimmer stimmen die transversalen Schwingungsmoden der Saite, aber die longitudinalen \hyperlink{moden}{Moden} sind durch den Aufbau der Saite und der Tonleiter festgelegt und können vom Stimmer nicht gesteuert werden, haben aber hörbare Effekte.
...
- die deutsche Ausgabe von \hyperlink{Gieseking}{Leimer/Gieseking}<br>
