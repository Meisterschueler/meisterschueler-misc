...
Das wichtigste ist die \hyperref[c1iii15]{Nervosität}\index{Nervosität} und ihre Auswirkungen auf den Geist, besonders bei Kindern.
...
Die grundlegenden Voraussetzungen für ein fehlerfreies Vorspielen sind: technische Vorbereitung, musikalische Interpretation, \hyperref[c1ii12mental]{mentales Spielen}\index{mentales Spielen} und ein gutes Verfahren für die Vorbereitung auf den Auftritt.
...
Beachten Sie, daß die Lernmethoden dieses Buchs so konzipiert sind, daß sie jeder dieser Entschuldigungen entgegenwirken und zwar hauptsächlich durch die Beschleunigung des Lernprozesses und durch die Förderung des \hyperref[c1iii6]{Auswendiglernens}\index{Auswendiglernens},
...
Wer keine Erfahrung im Vorspielen hat, spielt wegen der \hyperref[c1iii15]{Nervosität}\index{Nervosität} während des Konzerts oft schneller als er aufgrund seiner Fertigkeitsstufe kann. 
...
Hören Sie (beim Üben) stets Ihrer eigenen Musik zu, und führen Sie Ihre Musik mit dem \hyperref[c1ii12mental]{mentalen Spielen}\index{mentalen Spielen} -- das ist der einzige Weg, die Aufmerksamkeit des Publikums anzuziehen.
