...
\section{Schnell spielen: Tonleitern, Arpeggios und chromatische Tonleitern (Chopins Fantaisie Impromptu und Beethovens Mondschein-Sonate, 3. Satz)}\hypertarget{c1iii5}{}

\subsection{Tonleitern: Daumenuntersatz, Daumenübersatz}\hypertarget{c1iii5a}{}
...
Die Daumenübersatzschule (\hyperlink{Whiteside}{Whiteside}, \hyperlink{Sandor}{Sandor}) hat nach und nach die Oberhand gewonnen, und die hartnäckigeren Anhänger \textit{verbieten} die Benutzung des Untersatzes unter allen Umständen.
Sehen Sie dazu im \hyperlink{reference}{Quellenverzeichnis} weitere Diskussionen über das Lehren von Daumenuntersatz gegenüber Daumenübersatz.
...
Ein Nachteil davon, sowohl den Untersatz als auch den Übersatz zu lernen, ist, dass man beim \hyperlink{c1iii11}{Spielen vom Blatt} mit dem Daumen durcheinanderkommen kann und nicht weiß, welchen Weg man nehmen soll.
...
Beachten Sie, dass Chopin beide Methoden lehrte (\hyperlink{Eigeldinger}{Eigeldinger}, Seite 37).
...
\subsection{Daumenübersatz: Bewegung, Erklärung und Video}\hypertarget{c1iii5b}{}
...
Drehen Sie auch den Unterarm ein wenig im Uhrzeigersinn (Chopin nannte es die \enquote{Glissando-Position}, siehe unten in \hyperlink{c1iii5c}{5c}), was den Daumen automatisch vorwärts bringt.
...
Das macht es auch einfacher, \hyperlink{c1ii25}{beidhändig} zu spielen, da alle Finger beider Hände immer übersetzen.
