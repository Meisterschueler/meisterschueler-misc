...
\textbf{Es gibt nichts besseres, um die Wirksamkeit der \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} (siehe \autoref{c1iii7b}) zu demonstrieren, als sie zu benutzen, um den Triller zu lernen.
...
\hyperref[Whiteside]{Whiteside} beschreibt eine Methode, um den Triller zu üben, die eine Art von \hyperref[c1ii9]{Akkord-Anschlag}\index{Akkord-Anschlag} ist.
...
Aber die Lösung ist fast trivial -- wenden Sie die \hyperref[c1iii7b2]{Übung für 2-notige parallele Sets}\index{Übung für 2-notige parallele Sets} an.
...
Wenden Sie die \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} sowohl auf die Fingerbewegungen als auch die Armdrehungen an.
...
Die \hyperref[c1iii7b2]{Übung \#2 für parallele Sets}\index{Übung \#2 für parallele Sets} (zwei Noten) ist die beste Prozedur, um den Triller in guter Verfassung zu halten, besonders wenn man ihn eine Weile nicht benutzt hat oder ihn weiter verbessern möchte.
...
\textbf{Das letzte, was man tun möchte, ist, stundenlang diese Tremolos in der Hoffnung zu üben, Ausdauer aufzubauen -- das ist der sicherste Weg, \hyperref[c1ii22]{schlechte Angewohnheiten}\index{schlechte Angewohnheiten} zu erwerben und \hyperref[c1iii10hand]{Verletzungen}\index{Verletzungen} zu erleiden.}

Da Sie die Oktavtremolos bei beiden Händen benötigen, werden wir mit der linken und der rechten Hand abwechselnd üben; wenn die rechte es schneller begreift, können Sie sie \hyperref[c1ii20]{benutzen, um die linke zu unterrichten}\index{benutzen, um die linke zu unterrichten}.
...
Um das \hyperref[Noten]{C2-C3}\index{C2-C3}-Tremolo zu üben, üben Sie zunächst die C2-C3-Oktave (linke Hand).
Lassen Sie die Hand leicht \hyperref[c1ii9]{hoch- und runterspringen}\index{hoch- und runterspringen}, wiederholen Sie die Oktave mit Betonung der \hyperref[c1ii14]{Entspannung}\index{Entspannung} -- können Sie die Oktave ohne Ermüdung oder Stress weiterspielen, besonders wenn Sie schneller werden?
...
Wenn Sie die Oktave viermal je Schlag (einschließlich des korrekten \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus}) ohne Ermüdung wiederholen können, versuchen Sie, sie zu beschleunigen.
...
Sie können die Geschwindigkeit sogar noch mehr steigern, wenn Sie die \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} sowohl zu den Übungen der Fingerbewegung, der Armdrehung oder einer Kombination aus beiden hinzufügen.
Zuerst das 5,1-Set.
...
Das Grave, das diesen ersten Satz beginnt, ist wegen seines ungewöhnlichen \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus} und den schnellen Läufen in den Takten 4 und 10 nicht einfach, obwohl das Tempo langsam ist.
Der Rhythmus des ersten Takts ist nicht einfach, weil die erste Note des zweiten Schlags fehlt.
Um den korrekten Rhythmus zu lernen, benutzen Sie ein \hyperref[c1ii19]{Metronom}\index{Metronom} oder spielen Sie mit der linken Hand einzelne Rhythmusnoten, während Sie mit der rechten üben.
