...
\section{Triller und Tremolos (Beethovens Pathétique, 1. Satz)}
\label{c1iii3}

\subsection{Triller}

\textbf{Es gibt nichts besseres, um die Wirksamkeit der \hyperref[c1iii7b]{Übungen für parallele Sets} (siehe \ref*{c1iii7b}) zu demonstrieren, als sie zu benutzen, um den Triller zu lernen.
...
Sie sollten eventuell die Abschnitte \hyperref[c1iii7b]{\ref*{c1iii7b}} und \hyperref[c1iii7c]{\ref*{c1iii7c}} lesen, bevor Sie die parallelen Sets auf den Triller anwenden.
...
\subsection{Tremolos (Beethovens Pathétique, 1. Satz)}
\label{c1iii3b}
...
Der viernotige chromatische Fingersatz (\hyperref[c1iii5h]{\ref*{c1iii5h}}) kann bei solchen Geschwindigkeiten nützlich sein.
