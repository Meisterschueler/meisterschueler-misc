...
Spielen Sie den Ausschnitt wiederholt einhändig mit der schwierigeren Hand (siehe \enquote{\hyperref[c1iii2]{Zyklisch spielen}\index{Zyklisch spielen}} in Abschnitt III.2).
...
Ich habe drei Beispiele gewählt, um die beidhändigen Methoden zu veranschaulichen, angefangen mit dem einfachsten, dem \hyperref[c1ii25b]{ersten Satz von Beethovens Mondscheinsonate}\index{ersten Satz von Beethovens Mondscheinsonate}, dann \hyperref[c1ii25c]{Mozarts Rondo Alla Turca}\index{Mozarts Rondo Alla Turca}, und zum Schluss die anspruchsvolle \hyperref[c1ii25d]{Fantaisie-Impromptu (FI) von Chopin}\index{Chopin!Fantaisie-Impromptu (FI, Op. 66)}.
...
Das beidhändige Spielen ist etwas schwieriger als bei der \hyperref[c1ii25b]{Mondscheinsonate}\index{Beethoven!Mondscheinsonate}, weil dieses Stück schneller ist und eine höhere Genauigkeit erfordert.
...
Etwas einfachere Stücke sind die oben besprochenen -- \hyperref[c1ii25b]{Mondscheinsonate}\index{Beethoven!Mondscheinsonate} und das \hyperref[c1ii25c]{Rondo}\index{Rondo} -- sowie \hyperref[c1iii6l2]{Bachs Inventionen}\index{Bachs Inventionen} in Abschnitt III.6l.
...
die schwarzen Tasten sind jedoch einfacher zu spielen als die weißen, wenn Sie erst einmal die \hyperref[c1iii4b]{flachen Fingerhaltungen}\index{flachen Fingerhaltungen} (siehe III.4b) und den \hyperref[c1iii5b]{Daumenübersatz}\index{Daumenübersatz} (siehe III.5) kennen.
...
Hier benutzen wir das \enquote{Zirkulieren} -- sehen Sie dazu \enquote{\hyperref[c1iii2]{Zyklisch spielen}\index{Zyklisch spielen}} in Abschnitt III.2.
...
Die mathematischen Erklärungen und zusätzlichen herausragenden Punkte dieser Komposition werden ausführlicher unter \enquote{\hyperref[c1iii2]{Zyklisch spielen}\index{Zyklisch spielen}} in Abschnitt III.2 besprochen.
