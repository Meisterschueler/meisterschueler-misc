...
\subsection{Mit beiden Händen zusammen (\hyperref[HsHt]{HT}\index{HT}) üben und mental spielen}
\label{c1ii25}
...
Die vorangegangene Beschäftigung mit dem \hyperref[c1ii7]{einhändigen Spielen}\index{einhändigen Spielen} macht das Lernen dieser Koordination viel leichter, weil wir uns nur auf das Koordinieren konzentrieren müssen und nicht gleichzeitig auf das Koordinieren \textit{und} auf das Entwickeln von Finger- und Handtechnik.
...
Dieses \enquote{Geheimnis} ist ein angemessenes \hyperref[c1ii7]{Arbeiten mit getrennten Händen}\index{Arbeiten mit getrennten Händen}, Sie kennen es also bereits!
...
\begin{enumerate}[label={\arabic*.}] 
 ...
 \item \hyperref[c1ii22]{schlechte Angewohnheiten}\index{schlechte Angewohnheiten} aneignen,
...
Das beste Beispiel ist das Spielen mit \hyperref[c1iii5a]{untersetztem Daumen}\index{untersetztem Daumen}.
...
Falls Sie immer noch Probleme haben, benutzen Sie das \hyperref[c1iii8]{Konturieren}\index{Konturieren}.
...
Dafür gibt es viele Möglichkeiten, und Sie können in Abhängigkeit Ihrer Kenntnisse der Musiktheorie wirklich mächtige Methoden entwickeln, weshalb das Konturieren in \autoref{c1iii8} detaillierter besprochen wird.
...
Spielen Sie den Ausschnitt wiederholt einhändig mit der schwierigeren Hand (siehe \enquote{\hyperref[c1iii2]{Zyklisch spielen}\index{Zyklisch spielen}} in \autoref{c1iii2}).
...
Dieser Fehler liegt häufig im \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus}.
...
Das \hyperref[c1ii12mental]{mentale Spielen}\index{mentale Spielen} ist sowohl für das beidhändige als auch das einhändige Spielen notwendig, aber das beidhändige mentale Spielen ist natürlich für Anfänger schwieriger.
...
Ich habe drei Beispiele gewählt, um die beidhändigen Methoden zu veranschaulichen, angefangen mit dem einfachsten, dem \hyperref[c1ii25b]{ersten Satz von Beethovens Mondschein-Sonate}\index{ersten Satz von Beethovens Mondschein-Sonate}, dann \hyperref[c1ii25c]{Mozarts Rondo Alla Turca}\index{Mozarts Rondo Alla Turca}, und zum Schluss die anspruchsvolle \hyperref[c1ii25d]{Fantaisie-Impromptu (FI) von Chopin}\index{Fantaisie-Impromptu (FI) von Chopin}.
...
Ich gehe davon aus, dass Sie \hyperref[c1ii7]{einhändig}\index{einhändig} bereits die Hausaufgaben gemacht haben, und beginne mit dem beidhändigen Teil, insbesondere weil das einhändige Spielen bei den meisten Stücken von Mozart relativ einfach ist.
...
Diese Art der Analyse kann für das \hyperref[c1iii6]{Auswendiglernen}\index{Auswendiglernen} und das \hyperref[c1ii12mental]{mentale Spielen}\index{mentale Spielen} hilfreich sein -- schließlich hat er die Sonate mental komponiert!

Die technisch anspruchsvollen Teile sind:

\begin{enumerate}[label={\arabic*.}] 
 \item der schnelle Triller der rechten Hand in Takt 25,
 \item die schnellen Läufe der rechten Hand in den Takten 36-60 -- achten Sie auf einen guten \hyperref[c1ii18]{Fingersatz}\index{Fingersatz},
...
Die \hyperref[c1iii7b]{Übungen für parallele Sets}\index{Übungen für parallele Sets} sind der Schlüssel zur Entwicklung der zum Spielen dieser Elemente notwendigen Technik, und \hyperref[c1iii7b1]{Übung \#1}\index{Übung \#1} (Wiederholung von Quadrupeln, III.7b) ist die wichtigste, besonders zum Lernen der \hyperref[c1ii14]{Entspannung}\index{Entspannung}.
Informationen zu \hyperref[c1iii3]{schnellen Trillern}\index{schnellen Trillern} finden Sie in Abschnitt III.3a.
...
Da in den Takten 6-8 jede Note staccato sein muss, ist die einzige Möglichkeit, den \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus} zu betonen, den Akzent jeweils auf die erste Note jedes Takts zu legen.
\end{description}
...
Das beidhändige Spielen ist etwas schwieriger als bei der \hyperref[c1ii25b]{Mondschein-Sonate}\index{Mondschein-Sonate}, weil dieses Stück schneller ist und eine höhere Genauigkeit erfordert.
Der schwierigste Teil ist vielleicht das Koordinieren des \hyperref[c1iii3]{Trillers}\index{Trillers} in der rechten Hand mit der linken Hand in Takt 25.
...
und benutzen Sie die langsameren Geschwindigkeiten nur als letzten Ausweg, denn wenn Sie es schaffen, sparen Sie eine Menge Zeit und vermeiden es, sich \hyperref[c1ii22]{schlechte Angewohnheiten}\index{schlechte Angewohnheiten} anzueignen.}
...
Etwas einfachere Stücke sind die oben besprochenen -- \hyperref[c1ii25b]{Mondschein-Sonate}\index{Mondschein-Sonate} und das \hyperref[c1ii25c]{Rondo}\index{Rondo} -- sowie \hyperref[c1iii6l2]{Bachs Inventionen}\index{Bachs Inventionen} in Abschnitt III.6l.
...
die schwarzen Tasten sind jedoch einfacher zu spielen als die weißen, wenn Sie erst einmal die \hyperref[c1iii4b]{flachen Fingerhaltungen}\index{flachen Fingerhaltungen} (siehe \autoref{c1iii4b}) und den \hyperref[c1iii5b]{Daumenübersatz}\index{Daumenübersatz} (siehe III.5) kennen.
Chopin mag diese \enquote{weit entfernten} Tonarten aus diesem Grund gewählt haben, weil die Tonleiter bei der \hyperref[et1]{Gleichschwebenden Temperatur}\index{Gleichschwebenden Temperatur}, die er wahrscheinlich benutzte, nichts ausmacht (siehe \hyperref[c2_2c]{Kapitel 2, Abschnitt 2c}).}

Wir fangen an, indem wir die vorbereitenden Hausaufgaben mit dem \hyperref[c1ii7]{einhändigen Üben}\index{einhändigen Üben} und dem \hyperref[c1ii12mental]{mentalen Spielen}\index{mentalen Spielen} noch einmal durchgehen.
...
Das Strecken der linken Hand und das ständige Training machen die \hyperref[c1ii21]{Ausdauer}\index{Ausdauer} (das heißt die \hyperref[c1ii14]{Entspannung}\index{Entspannung}) zu einem Hauptthema.
...
Sie können damit anfangen, dass Sie Takt 5 mit der linken Hand üben und ihn fortlaufend \hyperref[c1iii2]{zyklisch spielen}\index{zyklisch spielen}, bis Sie ihn gut spielen können.
...
Die in Abschnitt III.5 beschriebene \hyperref[c1iii5wagen]{Wagenradbewegung}\index{Wagenradbewegung} kann hierbei hilfreich sein.
...
Benutzen Sie für das ansteigende Arpeggio in Takt 7 den \hyperref[c1iii5a]{Daumenübersatz}\index{Daumenübersatz}, weil es zu schnell ist, um es mit Untersatz zu spielen.
...
Hier benutzen wir das \enquote{Zirkulieren} -- sehen Sie dazu \enquote{\hyperref[c1iii2]{Zyklisch spielen}\index{Zyklisch spielen}} in \autoref{c1iii2}.
...
Die mathematischen Erklärungen und zusätzlichen herausragenden Punkte dieser Komposition werden ausführlicher unter \enquote{\hyperref[c1iii2]{Zyklisch spielen}\index{Zyklisch spielen}} in \autoref{c1iii2} besprochen.
