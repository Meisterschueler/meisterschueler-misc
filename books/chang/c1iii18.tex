...
Erstens sind die grundlegendsten Dinge, die Sie jedesmal beim Spielen benutzen, wie \hyperref[c1ii2]{Haltung der Hand}\index{Haltung der Hand}, \hyperref[c1ii3]{Sitzposition}\index{Sitzposition}, \hyperref[c1iii4]{Handbewegungen}\index{Handbewegungen} usw., in einem Lehrbuch schwer zu erklären, während Ihnen ein Lehrer sofort zeigen kann, was richtig und was falsch ist.
Sie möchten sich keine dieser falschen Angewohnheiten aneignen und Ihr ganzes Leben damit zurechtkommen müssen.
Zweitens macht ein Anfänger, der sich ans Klavier setzt und zum ersten Mal spielt, mindestens 20 Fehler gleichzeitig (\hyperref[c1ii25]{Koordination der rechten und linken Hand}\index{Koordination der rechten und linken Hand}, Kontrolle der \hyperref[c1iii14d]{Lautstärke}\index{Lautstärke}, \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus}, Arm- und \hyperref[c1iii4c]{Körperbewegungen}\index{Körperbewegungen}, \hyperref[c1ii13]{Geschwindigkeit}\index{Geschwindigkeit}, Timing, \hyperref[c1ii18]{Fingersatz}\index{Fingersatz}, der Versuch das Falsche zuerst zu lernen, völliges Vernachlässigen der \hyperref[c1iii14d]{Musikalität}\index{Musikalität} usw.).
...
Es gibt eine exzellente Website für Klavier \url{www.amsinternational.org/piano\_pedagogy.htm}, welche die meisten dieser Lehrbücher auflistet und viele davon bespricht.
...
Diese Bücher für den Anfang werden Ihnen die Grundlagen beibringen: \hyperref[c1iii11]{Notenlesen}\index{Notenlesen}, verschiedene allgemeine \hyperref[c1ii18]{Fingersätze}\index{Fingersätze} wie \hyperref[c1iii5a]{Tonleitern}\index{Tonleitern}, \hyperref[Arpeggios]{Arpeggios}\index{Arpeggios} und Begleitungen usw.
...
Im Grunde haben jedoch alle Keyboards eine Mechanik, die zu leicht ist, um wirklich ein \hyperref[c1iii17c]{akustisches Klavier}\index{akustisches Klavier} zu simulieren\footnote{\hyperref[c1iii17b]{elektronische Klaviere}\index{elektronische Klaviere} (Digitalpianos) sind in dieser Hinsicht bedeutend besser als Keyboards}.
...
Im Alter von mehr als vier Jahren können die meisten Kinder eine bestimmte Art von Musikerziehung erhalten, besonders wenn sie Musik seit der Geburt gehört haben; deshalb \textbf{sollten sie laufend auf ihr Verständnis der Tonhöhe (\hyperref[c1iii12]{relatives und absolutes Gehör}\index{relatives und absolutes Gehör}; können sie \enquote{eine Melodie halten}?), des \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus}, von laut und leise, von langsam  und schnell, sowie des Notenlesens, das leichter zu lernen ist als jedes Alphabet, getestet werden}.
...
\hyperref[c1ii12mental]{Mentales Spielen}\index{Mentales Spielen} ist nichts besonderes -- bei dieser Altersgruppe kommt es wie von selbst.
Viele Erwachsene halten das mentale Spielen für eine seltene Fertigkeit, weil sie es -- wie das \hyperref[c1iii12]{absolute Gehör}\index{absolutes Gehör} -- während ihrer Jugendzeit zu wenig benutzt und deswegen verloren haben.
...
Sie werden wahrscheinlich niemals etwas vergessen, das sie in diesem oder einem jüngeren Alter \hyperref[c1iii6]{auswendig gelernt}\index{auswendig gelernt} haben.
...
In dieser Altersgruppe kann die \hyperref[c1iii15]{Nervosität}\index{Nervosität} für einige zu einem großen Problem werden.
...
Wenn Sie \hyperref[c1iii14]{vorspielen}\index{vorspielen} möchten, sollten Sie sich deshalb mit der Kontrolle der Nervosität auseinandersetzen, z.B. indem Sie selbstsicherer werden oder indem Sie bei jeder Gelegenheit das öffentliche Vorspielen üben usw.
...
Obwohl einige \hyperref[c1iii6c]{Pflege}\index{Pflege} notwendig sein wird, können Sie alles ein Leben lang behalten, was Sie in dieser Altersstufe auswendig gelernt haben.


\label{c1iii18c35}

\textbf{Alter von 35 bis 45:}
Mitglieder dieser Altersgruppe können sich nicht zu Konzertpianisten entwickeln, können aber für einfacheres Material, wie leichte Klassik und Cocktail-Musik (\enquote{Fake Books}, Jazz), gut genug \hyperref[c1iii14]{vorspielen}\index{vorspielen}.
...
Die \hyperref[c1iii15]{Nervosität}\index{Nervosität} erreicht irgendwo im Alter von 40 bis 60 Jahren ein Maximum und nimmt danach oft langsam ab. 
Das mag erklären, warum viele berühmte Pianisten irgendwann in dieser Altersstufe mit dem Auftreten aufgehört haben.
Das \hyperref[c1iii6]{Auswendiglernen}\index{Auswendiglernen} beginnt in dem Sinne zu einem Problem zu werden, daß es zwar möglich ist, praktisch alles auswendig zu lernen, man aber dazu neigt, es fast völlig zu vergessen, wenn man es nicht richtig \hyperref[c1iii6c]{pflegt}\index{pflegt}.
...
Sich ein genügend großes Repertoire anzueignen wird schwierig sein, und man wird immer nur ein paar Stücke \hyperref[c1iii14]{vorspielen}\index{vorspielen} können.
...
Es gibt noch immer keine großen Probleme beim Lernen neuer Stücke, aber man muß sie ständig \hyperref[c1iii6c]{pflegen}\index{pflegen}, wenn man sie in seinem Repertoire behalten möchte.
...
Durch das mehrfache Vergessen und erneute \hyperref[c1iii6]{Auswendiglernen}\index{Auswendiglernen} können Sie trotzdem eine bedeutsame Menge Material auswendig lernen.
...
Eine Komposition \hyperref[c1iii6]{auswendig zu lernen}\index{auswendig zu lernen}, die man gerade übt, ist für die meisten kein Problem.
...
Die Hände zu dehnen, um weite Akkorde oder Arpeggios zu greifen, sowie schnelle Läufe werden schwieriger, und das \hyperref[c1ii14]{Entspannen}\index{Entspannen} wird ebenfalls schwerer.
Wenn Sie sich jeweils nur auf eine Komposition konzentrieren, können Sie immer eine oder zwei Kompositionen haben, die Sie \hyperref[c1iii14]{vorspielen}\index{vorspielen} können.
Es gibt keinen Grund, die Übungsmethoden zu ändern -- es sind dieselben, die auch für jüngere Schüler benutzt werden.
Und Sie werden nicht so \hyperref[c1iii15]{nervös}\index{nervös} sein, wie Sie eventuell in den mittleren Altersstufen waren.
