...
\section{Kalte Hände, rutschende Finger, Krankheiten, Handverletzungen, Gehörschäden}\hypertarget{c1iii10}{}

\subsection{Kalte Hände}
...
\subsection{Rutschende (trockene oder schwitzende) Finger}\hypertarget{c1iii10rutschen}{}
...
Üben Sie in diesem Fall, mit \hyperlink{c1iii4SchubZug}{Schub- und Zugbewegungen} zu spielen, so daß Sie die Position der Finger genauer kontrollieren können.
...
\subsection{Krankheiten}\hypertarget{c1iii10krank}{}
...
Vielleicht sind Übungen, die das Gehirn nicht belasten, wie z.B. \hyperlink{c1iii5}{Tonleitern}, \hyperlink{Arpeggios}{Arpeggios} und Übungen der \hyperlink{c1iii7h}{Hanon}-Art, in einer solchen Situation geeignet.
 

\subsection{Gesundes und ungesundes Üben}\hypertarget{c1iii10ungesund}{}
...
Aus der Unfähigkeit zum \hyperlink{c1iii6}{Auswendiglernen} oder zum Erwerben bestimmter Fertigkeiten resultierende Frustrationen müssen durch das Lernen effizienter Übungsmethoden verhindert werden.
In diesem Buch werden Methoden zum \hyperlink{c1ii14}{Vermeiden von Ermüdung} besprochen.
\hyperlink{c1iii10hand}{Verletzungen der Hand} sind vermeidbar.
Übermäßige \hyperlink{c1iii15}{Nervosität} ist nicht nur schlecht für das \hyperlink{c1iii14}{Auftreten}, sondern auch für die Gesundheit.
...
\subsection{Verletzungen der Hand}\hypertarget{c1iii10hand}{}
...
Es mag so erscheinen, als ob keine Verletzungen auftreten sollten, da die \hyperlink{c1ii14}{Entspannung} eine wichtige Komponente der Klaviertechnik ist.
...
Das jahrelange zu feste Greifen des Schlägers (ich wußte damals noch nichts über \hyperlink{c1ii14}{Entspannung}) führte jedoch an meinen Händen zu einem dauerhaften Schaden, so daß meine Finger nicht so unabhängig sind, wie ich es gerne hätte.
...
\textbf{Die \hyperlink{c1ii2}{gebogene Fingerhaltung} kann Prellungen der Fingerspitzen verursachen, weil das Polster zwischen Knochen und Haut an der Spitze minimal ist.}
...
Sie können beide Arten der Verletzung vermeiden, indem Sie die \hyperlink{c1iii4b}{flachen Fingerhaltungen} benutzen (s. Abschnitt III.4b).
...
Sehen Sie dazu im \hyperlink{Websites}{Quellenverzeichnis}  einige informative Websites über Handverletzungen bei Klavierspielern.


\subsection{Gehörschäden}\hypertarget{c1iii10gehoer}{}
...
Im \hyperlink{Websites}{Quellenverzeichnis} finden Sie Internet-Adressen zum Thema Gehörschäden.
...
\textbf{Die meisten \enquote{\hyperlink{upright}{Aufrechten}}, die keinen ausreichenden Klang erzeugen, sind wahrscheinlich am wenigsten schädlich.
...
Deshalb ist das richtige, regelmäßige \hyperlink{c2_7_hamm}{Intonieren der Hämmer} für das musikalische Spielen, die technische Entwicklung und den Schutz des Gehörs viel wichtiger als vielen Menschen bewußt ist.
