...
Diese Stufe wird im allgemeinen als das richtige Blattspiel angesehen und ist das Thema dieses Abschnitts.\footnote{Siehe auch \hyperref[c030530]{Prima-Vista-Spiel}\index{Prima-Vista-Spiel} im Quellenverzeichnis.}
...
Es folgen die Grundregeln des Blattspiels (siehe auch \hyperref[Richman]{Richman}\index{Richman}):

\begin{enumerate}[label={\arabic*.}] 
\item \textbf{Blicken Sie stets auf die Noten; schauen Sie nicht auf die Tastatur oder Finger.}
Schauen Sie gelegentlich auf die Hände, wenn es für große \hyperref[c1iii7f]{Sprünge}\index{Sprünge} notwendig ist.
...
\item \textbf{Lernen Sie alle allgemeinen musikalischen Konstrukte: Alberti-Begleitungen, Dur- und Moll-\hyperref[c1iii5]{Tonleitern}\index{Tonleitern} und ihre \hyperref[table]{Fingersätze}\index{Fingersätze} genauso wie die zugehörigen \hyperref[Arpeggios]{Arpeggios}\index{Arpeggios}, einfache Akkorde und Akkordumstellungen, Triller, Verzierungen usw.}
...
Da das Spielen vom Blatt so stark vom Erkennen von Strukturen abhängt, ist es nah mit dem \hyperref[c1iii6]{Auswendiglernen}\index{Auswendiglernen} verwandt.
...
Es ist eine große Hilfe für das \hyperref[c1iii6]{Auswendiglernen}\index{Auswendiglernen}, \hyperref[c1iii11]{Blattspiel}\index{Blattspiel}, beim Überwinden von Erinnerungsblockaden und für das Komponieren.
...
Mit der hier beschriebenen Methode werden die Fähigkeiten zur Erkennung von Tonhöhen einfach zu Nebenprodukten des \hyperref[c1iii6]{Auswendiglernens}\index{Auswendiglernens}.
...
In diesem Abschnitt haben wir gesehen, daß das endgültige Ziel des Auswendiglernens die Fähigkeit ist, die Musik in Gedanken zu spielen (\hyperref[c1iii6tastatur]{mentales Spielen}\index{mentales Spielen}).
...
Diese Vereinfachung ist möglich, weil die \hyperref[c2_2]{chromatische Tonleiter}\index{chromatische Tonleiter} logarithmisch aufgebaut ist; eine weitere Vereinfachung der Noten innerhalb der Oktave wird durch die Intervalle erreicht (Halbton, Terz, Quarte, Quinte).
