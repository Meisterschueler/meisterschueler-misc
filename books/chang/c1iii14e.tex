...
\hyperref[c1iii15]{Nervosität}\index{Nervosität} ist in der Regel kein Thema, und das zwanglose Vorspielen ist sogar eine der besten Möglichkeiten, Methoden zur Vermeidung von Nervosität zu üben.
...
Die meisten Menschen nehmen an, daß alle Amateurklavierspieler Stücke vom Anfang bis zum Ende mit einem \hyperref[c1iii6d]{Hand-Gedächtnis}\index{Hand-Gedächtnis} lernen, und daß die Fähigkeit Auszüge zu spielen ein besonderes Talent erfordert.
...
Offensichtlich sollte das Spielen von Auszügen eines der Dinge sein, die sie regelmäßig \hyperref[c1iii6g]{\enquote{kalt} üben}\index{\enquote{kalt} üben}.
...
Prüfen Sie vor allen Dingen, ob Sie sie \hyperref[c1ii12mental]{in Gedanken (ohne das Klavier) spielen}\index{in Gedanken (ohne das Klavier) spielen} können -- das ist der ultimative Test, ob Sie bereit sind.
...
Die Wichtigkeit eines sicheren \hyperref[c1ii12mental]{mentalen Spielens}\index{mentalen Spielens} muß noch einmal betont werden -- es ist der ultimative Test für das Gedächtnis und ob Sie zum Auftreten bereit sind.
...
Machen Sie es sich zur Angewohnheit, Ihre Konzertstücke \enquote{\hyperref[c1iii6g]{kalt}\index{kalt}} (ohne Aufwärmen) zu spielen, wenn Sie eine Übungseinheit beginnen.
