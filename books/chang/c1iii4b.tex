...
\subsection{Mit flachen (gestreckten) Fingern spielen}\hypertarget{c1iii4b}{}

Wir stellten in \hyperlink{c1ii2}{Abschnitt II.2} fest, dass die anfängliche Fingerform für das Lernen des Klavierspielens die teilweise gebogene Haltung ist.
...
\textbf{Die wichtigsten Vorteile der flachen Haltung sind, dass sie die Bewegung der Finger vereinfacht und eine völlige \hyperlink{c1ii14}{Entspannung} ermöglicht}, das heißt die Zahl der Muskeln, die gebraucht werden, um die Fingerbewegung zu kontrollieren, ist kleiner als bei der gebogenen Haltung, weil alles was man tun muss, das Drehen des gesamten Fingers um den Knöchel ist.
...
Anfänger, die versuchen, mit der flachen Haltung schnell zu spielen, werden wahrscheinlich mit \hyperlink{c1ii11}{parallelen Sets} mit festen Phasen spielen anstatt mit unabhängigen Fingern.
...
\hyperlink{Sandor}{Sandor} nennt die flachen Fingerhaltungen \enquote{falsche Haltungen}, aber \hyperlink{Fink}{Fink} empfiehlt bestimmte Haltungen, die klar flache Fingerhaltungen sind (wir werden unten verschiedene flache Haltungen behandeln).
\textbf{\hyperlink{c1iii3}{Triller} erfordern oft wegen ihrer komplexen Art die gebogene Haltung.}
...
Aus diesem Grund verwenden die meisten Klavierspieler (besonders jene mit kleinen Händen) bereits die flache Haltung für das Spielen \hyperlink{c1iii7e}{großer Akkorde} usw., oftmals ohne es zu merken.
...
Der Fingersatz für diese Tonleiter ist bei der rechten Hand der \hyperlink{table}{Standard-Fingersatz}, aber die linke Hand muss mit dem vierten Finger auf dem H beginnen.
Sie möchten vielleicht zunächst den folgenden Abschnitt (III.5) über das \hyperlink{c1iii5}{Spielen schneller Tonleitern} lesen, bevor Sie mit dieser Übung fortfahren, weil Sie wissen müssen, wie man mit Daumenübersatz spielt, wie man die Glissandobewegungen benutzt usw.
...
Benutzen Sie in diesem Fall \hyperlink{c1ii20}{die stärkere Hand, um die schwächere zu unterrichten}, wie man spielt.
...
Wenn Sie beim Spielen mit der flachen Fingerhaltung auf irgendwelche Schwierigkeiten stoßen, versuchen Sie die \hyperlink{c1iii7b}{Übungen für parallele Sets} mit den schwarzen Tasten.
...
Man kann auch das Handgelenk heben, sodass sich die Finger in Wahrheit rückwärts biegen (entgegen der Richtung beim Krümmen), wie bei der \hyperlink{c1iii5wagen}{Wagenradbewegung} (III.5e).
...
Da Sie das dritte Fingerglied völlig entspannen und auch einige der Streckmuskeln ignorieren können, sind die flachen Fingerbewegungen einfacher, und Sie können schneller spielen, besonders bei schwierigem Material wie schnellen \hyperlink{c1iii3}{Trillern}.
...
So hatte ich zum Beispiel ein paar Stress-Probleme beim Beschleunigen von \hyperlink{c1iii20}{Bachs Inventionen}, weil sie die Unabhängigkeit der Finger erfordern, besonders der Finger 3, 4 und 5.
...
Die falsche Vorstellung, dass die flache Haltung schlecht für die Technik sei, kommt von der Tatsache, dass sie zu \hyperlink{c1ii22}{schlechten Angewohnheiten} führen kann, die mit dem falschen Gebrauch der \hyperlink{c1ii11}{parallelen Sets} zusammenhängen.
...
Die zweitwichtigste Haltung ist die flach ausgestreckte Haltung, weil sie zum Spielen \hyperlink{c1iii7e}{weiter Akkorde} und Arpeggios gebraucht wird.
...
Die flachen Fingerhaltungen sind auch mit der \hyperlink{c1ii3}{Höhe der Sitzbank} verbunden.
