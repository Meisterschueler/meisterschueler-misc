...
\subsection{Langzeitgedächtnis aufbauen}\hypertarget{c1iii6j}{} 
...
Wir haben \hyperlink{c1iii6d}{oben} bereits das \textbf{Hand-Gedächtnis} besprochen.
...
Diejenigen mit \hyperlink{c1iii12}{absolutem Gehör} werden damit ebenfalls Erfolge erzielen, weil sie die Noten auf dem Klavier einfach nach ihrer Erinnerung der Musik finden können.
...
Es hängt von der Art ihres Gehirns ab, und man kann diese Fähigkeit trainieren, wie es unten in Abschnitt \hyperlink{c1iii6m}{III.6m} besprochen wird.
...
\textbf{Bei denjenigen, die das Singen vom Blatt lernen und ein absolutes Gehör erwerben möchten (\hyperlink{c1iii12}{s. Abschnitt 12}), entwickeln sich diese Fertigkeiten durch das mentale Spielen automatisch.}
...
Beim \hyperlink{c1iii6d}{Hand-Gedächtnis} ist es im Gegenteil dazu so, daß es schwieriger wird, mehr auswendig zu lernen, wenn Ihr Repertoire größer wird, weil die Wahrscheinlichkeit der Konfusion steigt.
...
Sie müssen gleichzeitig\footnote{in Gedanken} die Musik hören, so daß das \hyperlink{c1iii6musik}{Musik-Gedächtnis} ein Teil dieses Prozesses ist.
Benutzen Sie das \hyperlink{c1iii6foto}{fotografische Gedächtnis}, wann immer es einfach ist, und fügen Sie soviel \hyperlink{c1iii6theorie}{theoretisches Gedächtnis} (s.u.) wie möglich hinzu.
...
Sie können damit die \hyperlink{c1iii15}{Nervosität} reduzieren, und es ist der schnellste und leichteste Weg, sich ein \hyperlink{c1iii12}{relatives und ein absolutes Gehör} anzueignen.
...
Es verfestigt nicht nur das \hyperlink{c1iii6tastatur}{Tastatur-Gedächtnis}, sondern unterstützt auch das \hyperlink{c1iii6musik}{Musik-Gedächtnis}, \hyperlink{c1iii6foto}{fotografische Gedächtnis}, \hyperlink{c1iii14}{Vorspielen}, die \hyperlink{c1iii12}{Genauigkeit der Tonhöhe}, \hyperlink{c1iii6g}{kalt spielen} usw., und sollte der erste Schritt beim \hyperlink{c1iii14d}{musikalischen Spielen} sein.
...
Beginnen Sie mit dem Lernen der chromatischen Tonleiter und des Quintenzirkels (\hyperlink{c2_2}{Kapitel 2, Abschnitt 2}).
Jeder kann eine einfache Strukturanalyse durchführen: \hyperlink{c1iv4}{Mozarts Wiederholungen}, \hyperlink{c1iii20}{einfache parallele Sets in Bachs technischen Stücken}, Konzepte ähnlich der \hyperlink{c1iv4Gruppe}{Gruppentheorie in Beethovens Musik}, wiederholtes Benutzen derselben Akkordprogressionen in Chopins Musik usw.
...
\subsection{Pflege}\hypertarget{c1iii6k}{}

\textbf{Es gibt keine effektivere Pflegeprozedur als das \hyperlink{c1iii6tastatur}{Tastatur-Gedächtnis und das mentale Spielen}.}
...
Gute Auswendiglernende haben die Angewohnheit entwickelt, ihr Gedächtnis ständig zu \hyperlink{c1iii2}{zirkulieren}.
...
Wenn Ihr \hyperlink{c1iii6tastatur}{mentales Spielen} gut ist, sollten Sie mit jeder Note beginnen können, nicht nur mit dem Anfang einer Phrase.
\item Stellen Sie fest, ob sie ohne Fehler und Gedächtnisblockaden sehr \hyperlink{c1iii6h}{langsam spielen} können.
\item Spielen Sie \enquote{\hyperlink{c1iii6g}{kalt}}. Es wird Ihre Fähigkeit zum \hyperlink{c1iii14}{Vorspielen} sehr steigern.
\item \hyperlink{c1iii6tastatur}{Spielen Sie \enquote{in Gedanken}}, zumindest HS.
