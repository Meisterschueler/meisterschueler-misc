...
\label{c1iii6hand}
Wir haben \hyperref[c1iii6d]{oben}\index{oben} bereits das \textbf{Hand-Gedächtnis} besprochen.
...
Diejenigen mit \hyperref[c1iii12]{absolutem Gehör}\index{absolutem Gehör} werden damit ebenfalls Erfolge erzielen, weil sie die Noten auf dem Klavier einfach nach ihrer Erinnerung der Musik finden können.
...
Beim \hyperref[c1iii6d]{Hand-Gedächtnis}\index{Hand-Gedächtnis} ist es im Gegenteil dazu so, daß es schwieriger wird, mehr auswendig zu lernen, wenn Ihr Repertoire größer wird, weil die Wahrscheinlichkeit der Konfusion steigt.
...
Sie müssen gleichzeitig\footnote{in Gedanken} die Musik hören, so daß das \hyperref[c1iii6musik]{Musik-Gedächtnis}\index{Musik-Gedächtnis} ein Teil dieses Prozesses ist.
Benutzen Sie das \hyperref[c1iii6foto]{fotografische Gedächtnis}\index{fotografische Gedächtnis}, wann immer es einfach ist, und fügen Sie soviel \hyperref[c1iii6theorie]{theoretisches Gedächtnis}\index{theoretisches Gedächtnis} (s.u.) wie möglich hinzu.
...
Sie können damit die \hyperref[c1iii15]{Nervosität}\index{Nervosität} reduzieren, und es ist der schnellste und leichteste Weg, sich ein \hyperref[c1iii12]{relatives und ein absolutes Gehör}\index{relatives und ein absolutes Gehör} anzueignen.
...
Es verfestigt nicht nur das \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis}\index{Tastatur-Gedächtnis}, sondern unterstützt auch das \hyperref[c1iii6musik]{Musik-Gedächtnis}\index{Musik-Gedächtnis}, \hyperref[c1iii6foto]{fotografische Gedächtnis}\index{fotografische Gedächtnis}, \hyperref[c1iii14]{Vorspielen}\index{Vorspielen}, die \hyperref[c1iii12]{Genauigkeit der Tonhöhe}\index{Genauigkeit der Tonhöhe}, \hyperref[c1iii6g]{kalt spielen}\index{kalt spielen} usw., und sollte der erste Schritt beim \hyperref[c1iii14d]{musikalischen Spielen}\index{musikalischen Spielen} sein.
...
\textbf{Es gibt keine effektivere Pflegeprozedur als das \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis und das mentale Spielen}\index{Tastatur-Gedächtnis und das mentale Spielen}.}
...
Gute Auswendiglernende haben die Angewohnheit entwickelt, ihr Gedächtnis ständig zu \hyperref[c1iii2]{zirkulieren}\index{zirkulieren}.
...
Wenn Ihr \hyperref[c1iii6tastatur]{mentales Spielen}\index{mentales Spielen} gut ist, sollten Sie mit jeder Note beginnen können, nicht nur mit dem Anfang einer Phrase.
\item Stellen Sie fest, ob sie ohne Fehler und Gedächtnisblockaden sehr \hyperref[c1iii6h]{langsam spielen}\index{langsam spielen} können.
\item Spielen Sie \enquote{\hyperref[c1iii6g]{kalt}\index{kalt}}. Es wird Ihre Fähigkeit zum \hyperref[c1iii14]{Vorspielen}\index{Vorspielen} sehr steigern.
\item \hyperref[c1iii6tastatur]{Spielen Sie \enquote{in Gedanken}}\index{Spielen Sie \enquote{in Gedanken}}, zumindest HS.
