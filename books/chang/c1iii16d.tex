...
\textbf{Tonleitern sollten Anfängern mit dem Daumenuntersatz gelehrt werden, aber innerhalb eines Jahres sollte ihnen auch der \hyperref[c1iii5b]{Daumenübersatz}\index{Daumenübersatz} beigebracht werden.}
Obwohl die meisten Übungen wie \hyperref[c1iii7h]{Hanon}\index{Hanon} heute als nicht hilfreich angesehen werden, ist es sehr wichtig, in der Lage zu sein, \hyperref[c1iii5]{Tonleitern und Arpeggios}\index{Tonleitern und Arpeggios} (in allen Tonarten)
...
\textbf{Der beste Weg, Schüler zum Üben zu motivieren, und die beste Art, die Kunst Musik zu machen zu lehren, ist, \hyperref[c1iii14]{Konzerte}\index{Konzerte} abzuhalten.}
...
Sehen Sie dazu oben in Abschnitt 15 eine Besprechung über die \hyperref[c1iii15]{Kontrolle der Nervosität}\index{Kontrolle der Nervosität}.
...
Vor allem müssen sie das \hyperref[c1ii12mental]{mentale Spielen}\index{mentale Spielen} lernen.
Wir haben gesehen, daß HS-Üben, \hyperref[c1ii17]{langsames Spielen}\index{langsames Spielen} und \hyperref[c1iii6g]{\enquote{kalt} spielen}\index{\enquote{kalt} spielen} die wichtigen Komponenten der Vorbereitung sind.
...
\textbf{Eine der besten Möglichkeiten, für Auftritte zu trainieren, ist, die fertigen Stücke des Schülers \hyperref[c1iii13]{aufzunehmen}\index{aufzunehmen} und ein Album des fertigen Repertoires herzustellen, das regelmäßig auf den neuesten Stand gebracht wird, wenn der Schüler Fortschritte macht.}
...
\textbf{Ein sicheres \hyperref[c1ii12mental]{mentales Spielen}\index{mentales Spielen} ist die effektivste Methode, das Lampenfieber zu reduzieren.}
...
\hyperref[c1ii12mental]{Wie spielt man in Gedanken}\index{Wie spielt man in Gedanken}?
Tut man es ständig?
Benutzt man das \hyperref[c1iii6foto]{fotografische Gedächtnis}\index{fotografische Gedächtnis} oder das \hyperref[c1iii6tastatur]{Tastatur-Gedächtnis}\index{Tastatur-Gedächtnis} oder nur das \hyperref[c1iii6musik]{Musik-Gedächtnis}\index{Musik-Gedächtnis}?
...
Jeder Streß oder \hyperref[c1iii15]{Nervosität}\index{Nervosität}, die sie fühlen könnten, wird weniger angsteinflößend, wenn sie erkennen, daß jeder dieselben Dinge erlebt, daß Nervosität absolut natürlich ist, und daß es verschiedene Möglichkeiten gibt, sie zu bekämpfen oder sogar einen Vorteil daraus zu ziehen.
...
Während die Schüler an einem \enquote{Wettbewerb} teilnehmen, muß der Lehrer sicherstellen, daß es eine freudige Erfahrung ist, eine Möglichkeit, die Freude am Auftreten zu erfahren, eine Möglichkeit, die \hyperref[c1iii15]{Nervosität}\index{Nervosität} völlig zu vergessen.
