...
\textbf{Schließlich führt Auswendiglernen, und das ist der \enquote{entscheidende Faktor}, zu \hyperref[c1iii6tastatur]{mentalem Spielen}\index{mentalem Spielen} (s. Abschnitt 1.III.6j), das der Schlüssel zu einem \hyperref[c1iii12]{absoluten Gehör}\index{absolutes Gehör}, einem höheren effektiven IQ, reduzierter \hyperref[c1iii15]{Nervosität}\index{Nervosität} bzw. Streß, zum Komponieren und zur Fähigkeit, mit Leichtigkeit und ohne Fehler vorzuspielen, ist.}
...
\hyperref[c1iii11]{Vom Blatt zu spielen}\index{Vom Blatt zu spielen} ist eine gesonderte Fertigkeit, die in Abschnitt III.11 behandelt wird.
