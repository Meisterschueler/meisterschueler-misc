...
Üben Sie diese Geschwindigkeiten, weil diese eventuell gebraucht werden, wenn Sie mit dem \hyperref[c1ii25]{beidhändigen Spielen}\index{beidhändigen Spielen} anfangen.
...
\textbf{\hyperref[c1ii7]{Wechseln Sie oft die Hände}\index{Wechseln Sie oft die Hände}, um Verletzungen zu vermeiden.}
...
Der Komponist kann geschickt beiden Erfordernissen genügen, indem er die erste Note eliminiert und so den \hyperref[c1iii1b]{Rhythmus}\index{Rhythmus} bewahrt und doch leise anfängt (in diesem Fall kein Ton)!
Sie werden keine Schwierigkeiten haben, zahlreiche Beispiele dieses Mittels zu finden -- sehen Sie dazu \hyperref[c1iii20]{Bachs Inventionen}\index{Bachs Inventionen}.
...
Im langsamen Abschnitt ist das Gis ein As, was\footnote{bei \hyperref[et1]{gleichmäßig temperierter Stimmung}\index{gleichmäßig temperierter Stimmung}} dieselbe Note ist.
