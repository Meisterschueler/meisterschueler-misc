...
Beim Ausfeilen eines \enquote{fertigen} Stückes möchte man fünf Ziele erreichen: ein gutes \hyperref[c1iii6]{Gedächtnis}\index{Gedächtnis} gewährleisten, Fehler beseitigen, \hyperref[c1iii14d]{Musik machen}\index{Musik machen}, die Technik weiterentwickeln und sich \hyperref[c1iii14]{auf Auftritte vorbereiten}\index{auf Auftritte vorbereiten}.
...
\hyperref[c1ii12]{Mentales Spielen}\index{Mentales Spielen} garantiert, daß das Gedächtnis praktisch unfehlbar ist.
...
Erinnerungsblockaden treten wegen einer zu großen Abhängigkeit vom \hyperref[c1iii6hand]{Hand-Gedächtnis}\index{Hand-Gedächtnis} auf.
\hyperref[c1ii22]{Stottern}\index{Stottern} ist die Angewohnheit, bei jedem Fehler anzuhalten, während man HT spielt, ohne vorher genügend HS geübt zu haben.
Man trifft falsche Noten, weil die Hände nicht stets die Tasten fühlen und man nicht mehr weiß, wo welche Tasten sind.
Fehlende Noten resultieren aus einem Mangel an \hyperref[c1ii14]{Entspannung}\index{Entspannung} und dem ungewollten Heben der Hände -- eine Angewohnheit, die man üblicherweise durch zuviel langsames HT-Üben erwirbt.
...
Bei zu schwierigem Material weiß man nie, was geschieht, und häufig führt solch ein Versuch zu irreversiblen Problemen wie Streß und \hyperref[c1iv2b]{Geschwindigkeitsbarrieren}\index{Geschwindigkeitsbarrieren}.
...
Ihre Fertigkeiten zum Vorspielen zu perfektionieren, ist Teil des Ausfeilens; das wird unten in \hyperref[c1iii14]{\autoref{c1iii14}} besprochen.
...
Nicht zu wissen, welcher der beiden Zustände auf einen zukommt, kann ein schrecklicher Gedanke sein, der \hyperref[c1iii15]{Nervosität}\index{Nervosität} hervorrufen kann.
Offensichtlich gibt es viele Faktoren, wie z.B. \hyperref[fpd]{FPD}\index{FPD}, der besonnene Gebrauch des \hyperref[c1ii17]{langsamen Spielens}\index{langsamen Spielens} usw.
Der wichtigste Faktor ist jedoch das \hyperref[c1ii12]{mentale Spielen}\index{mentale Spielen}.
...
Zusammengefaßt \textbf{ist ein solides \hyperref[c1ii12]{mentales Spielen}\index{mentales Spielen} die wichtigste Voraussetzung dafür, ein Stück auszufeilen und es für einen Auftritt vorzubereiten}.
